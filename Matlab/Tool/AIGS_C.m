function out = AIGS_C(fea,options)
%% load options
% Default options
...
idg = 1:size(fea,1); thr_1 = filter_thr(1); thr_2 = filter_thr(2); num_gene = zeros(3,1); num_gene(1) = length(idg);
